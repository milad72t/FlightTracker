...
<div class="row">
    <div class="x_content">
        <div class="x_panel">
            <div class="x_title">
                <h2>ثبت اطلاعات شرکت هواپیمایی (ایرلاین)</h2>
            ...
            <div class="x_content">
                <form method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="text" id="alias" name="alias" Lang="fa-IR" value="{{ old('alias') }}"  class="form-control col-md-7 col-xs-12">
                            @if($errors->has('alias'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="text" id="callSign" name="callSign" class="form-control col-md-7 col-xs-12">
